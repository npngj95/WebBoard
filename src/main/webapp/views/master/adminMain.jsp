...
<body>
	...
	<div class="row container wrapper text-center">
		...
		<div class="col border border-light w-25 m-3 p-0 display-inlineblock rounded mb-0">
			<p class="h4 m-0 py-3 bg-primary text-white"><i class="fas fa-bullhorn mr-3"></i>공지글 관리</p>
			<div class="row-sm">
			...
			<div class="row-sm">
				<button type="button" class="btn waves-effect mx-0 my-0 w-100" onclick="location='./noticeList.jsp'">
  				공지글 조회</button>
			</div>
		</div>
		
		<div class="col border border-light w-25 m-3 p-0 display-inlineblock rounded mb-0">
			<p class="h4 m-0 py-3 bg-primary text-white"><i class="fas fa-user prefix mr-3"></i>회원 관리</p>
			<div class="row-sm">
				<button type="button" class="h4 btn border-bottom border-linght waves-effect mx-0 my-0 w-100"
