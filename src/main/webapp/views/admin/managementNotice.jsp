...
<div class="card card-cascade narrower wrapper">
  ...
  <div class="view view-cascade gradient-card-header btn-teal narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
    ...
    <b class="white-text mx-3">공지글 관리</b>
	    ...
	    <form name="managementNotice" action="deleteNotice.jsp" method="post">
	      ...
	      <table class="table table-hover mb-3">
	        ...
	        <tbody>
	          <tr>
	            <th scope="row">
	              <input class="form-check-input" type="checkbox" name="noticeCheck" value="게시글번호1">
	            </th>
	            <td>공지</td>
	          ...
	          <tr>
	            <th scope="row">
	              <input class="form-check-input" type="checkbox" name="noticeCheck" value="게시글번호2">
	            </th>
	            <td>공지</td>
